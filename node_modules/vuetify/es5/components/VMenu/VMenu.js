...
var _SlotProvider = require('../../util/SlotProvider');

var _SlotProvider2 = _interopRequireDefault(_SlotProvider);
...
exports.default = _vue2.default.extend({
    ...
    render: function render(h) {
        ...
        return h('div', data, [this.genActivator(), this.$createElement(_SlotProvider2.default, {
            props: {
                provide: {
